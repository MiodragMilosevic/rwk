...
export class NewsComponent implements OnInit {
  ...
  constructor(private pageService: PageService, private sanitizer: DomSanitizer, private userService: UserService, private storageService: StorageService, private router: Router,
  ...
  getContent() {
    this.pageService.getContent('news').subscribe(res => {
      this.content = res[0].content;
      this.content.html = this.sanitizer.bypassSecurityTrustHtml(this.content.html);
    }, err => {
