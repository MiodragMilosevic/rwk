...
@Component({
  selector: 'app-certified-teachers',
  templateUrl: './certified-teachers.component.html',
  styleUrls: ['./certified-teachers.component.scss']
})
export class CertifiedTeachersComponent implements OnInit {
  content: any;
  currentLevel: any;
  ...
  getContent() {
    this.pageService.getContent("certified_teachers").subscribe(res => {
